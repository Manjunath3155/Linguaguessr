    ...
    <div className="flex min-h-[calc(100vh-4rem)] flex-col items-center justify-center px-4">
      ...
      <div className="relative z-10 flex flex-col items-center text-center">
        ...
        <div className="mb-8 flex h-24 w-24 items-center justify-center rounded-full bg-gradient-to-br from-accent/20 to-accent-secondary/20 globe-glow">
          <svg data-lingo-skip width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-accent">
        ...
        <p className="mb-2 max-w-lg text-lg text-muted sm:text-xl">
          Hear a language. Pin it on the map. How close can you get?
        </p>
        <p className="mb-10 text-sm text-muted/60">
          125+ languages from around the world &middot; Max 5,000 pts/round
        </p>
        ...
        <div className="flex flex-col gap-4 sm:flex-row">
          ...
          >
            <svg data-lingo-skip width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="transition-transform group-hover:scale-110">
          ...
          >
            <svg data-lingo-skip width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="mt-20 grid max-w-3xl grid-cols-1 gap-6 sm:grid-cols-3">
          <div className="rounded-xl border border-border bg-surface/50 p-6 text-center">
            ...
            <h3 className="mb-1 font-semibold">Listen</h3>
            <p className="text-sm text-muted">Hear a clip of someone speaking a mystery language</p>
          </div>
          <div className="rounded-xl border border-border bg-surface/50 p-6 text-center">
            ...
            <h3 className="mb-1 font-semibold">Pin</h3>
            <p className="text-sm text-muted">Click on the world map to place your guess</p>
          </div>
          <div className="rounded-xl border border-border bg-surface/50 p-6 text-center">
            <div className="mb-3 flex h-12 w-12 mx-auto items-center justify-center rounded-full bg-green-500/10">
              <svg data-lingo-skip width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-green-400">
                <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14" />
                <polyline points="22 4 12 14.01 9 11.01" />
              </svg>
            </div>
            <h3 className="mb-1 font-semibold">Score</h3>
            <p className="text-sm text-muted">The closer your pin, the more points you earn!</p>
          </div>
        </div>
        ...
        <div className="mt-16 flex items-center gap-2 rounded-full border border-border bg-surface/50 px-4 py-2 text-xs text-muted">
          ...
          <span>&middot;</span>
          <span>Translated into 8 languages</span>
        </div>
      </div>
    </div>
  );
